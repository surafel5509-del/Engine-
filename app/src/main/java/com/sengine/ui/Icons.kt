...
object Icons {
    private val defs: Map<String, String> = mapOf(
        ...
        "robot" to "r 5 8 14 11 3;l 12 8 12 4;C 12 3.5 1.2;C 9 13 1.4;C 15 13 1.4;l 9 16.5 15 16.5;l 3 12 3 15;l 21 12 21 15",
        "tank" to "r 3 13 18 6 3;r 7 9 9 4 1;l 16 11 22 9;C 7 16 1;C 12 16 1;C 17 16 1",
        "water" to "q 12 3 6 14 12 20;q 12 20 18 14 12 3;l 2 21 22 21",
        "pencil" to "g 4 20 5 15 16 4 20 8 9 19;l 14 6 18 10",
        "bucket" to "g 5 9 19 9 17 20 7 20;q 5 9 12 3 19 9;l 19 12 21 16",
        "eraser" to "g 3 15 12 6 20 14 13 21 7 21;l 8 11 15 18",
        "pipette" to "l 4 20 13 11;g 11 9 15 5 19 9 15 13;l 17 3 21 7",
        "lasso" to "e 12 9 8 5 0;q 6 13 8 20 10 21",
    )
